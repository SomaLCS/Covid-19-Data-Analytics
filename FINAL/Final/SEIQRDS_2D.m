...
figure(1)
plot(time,S(k,:),'Color','#0071BC')
hold on
plot(time,E(k,:),'Color','#D85218')
plot(time,I(k,:),'Color','#ECB01F')
plot(time,H(k,:),'Color','#7D2E8D')
plot(time,R(k,:),'Color','#76AB2F')
plot(time,D(k,:),'Color','#4CBDED')
